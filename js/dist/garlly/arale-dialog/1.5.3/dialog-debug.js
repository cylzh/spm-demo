define("garlly/arale-dialog/1.5.3/dialog-debug", ["garlly/jquery/1.7.2/jquery-debug","garlly/arale-overlay/1.2.0/overlay-debug","garlly/position/1.1.0/index-debug","garlly/arale-iframe-shim/1.1.0/index-debug","garlly/arale-widget/1.2.0/widget-debug","garlly/arale-base/1.2.0/base-debug","garlly/arale-class/1.2.0/class-debug","garlly/arale-events/1.2.0/events-debug","garlly/arale-templatable/0.10.0/src/templatable-debug","garlly/handlebars/1.3.0/dist/cjs/handlebars-debug","garlly/arale-messenger/2.1.0/index-debug","garlly/handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug"], function(require, exports, module){
module.exports = require("garlly/arale-dialog/1.5.3/src/dialog-debug");
module.exports.ConfirmBox = require("garlly/arale-dialog/1.5.3/src/confirmbox-debug");

});
define("garlly/arale-dialog/1.5.3/src/dialog-debug", ["garlly/jquery/1.7.2/jquery-debug","garlly/arale-overlay/1.2.0/overlay-debug","garlly/position/1.1.0/index-debug","garlly/arale-iframe-shim/1.1.0/index-debug","garlly/arale-widget/1.2.0/widget-debug","garlly/arale-base/1.2.0/base-debug","garlly/arale-class/1.2.0/class-debug","garlly/arale-events/1.2.0/events-debug","garlly/arale-templatable/0.10.0/src/templatable-debug","garlly/handlebars/1.3.0/dist/cjs/handlebars-debug","garlly/arale-messenger/2.1.0/index-debug","garlly/handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug"], function(require, exports, module){
var $ = require("garlly/jquery/1.7.2/jquery-debug"),
    Overlay = require("garlly/arale-overlay/1.2.0/overlay-debug"),
    mask = Overlay.Mask,
    Events = require("garlly/arale-events/1.2.0/events-debug"),
    Templatable = require("garlly/arale-templatable/0.10.0/src/templatable-debug"),
    Messenger = require("garlly/arale-messenger/2.1.0/index-debug");
...
var Dialog = Overlay.extend({
  ...
  attrs: {
    // 模板
    template: require("garlly/arale-dialog/1.5.3/src/dialog-debug.handlebars"),
...
define("garlly/arale-dialog/1.5.3/src/dialog-debug.handlebars", ["garlly/handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug"], function(require, exports, module){
var Handlebars = require("garlly/handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug")["default"];
...
define("garlly/arale-dialog/1.5.3/src/confirmbox-debug", ["garlly/jquery/1.7.2/jquery-debug","garlly/arale-overlay/1.2.0/overlay-debug","garlly/position/1.1.0/index-debug","garlly/arale-iframe-shim/1.1.0/index-debug","garlly/arale-widget/1.2.0/widget-debug","garlly/arale-base/1.2.0/base-debug","garlly/arale-class/1.2.0/class-debug","garlly/arale-events/1.2.0/events-debug","garlly/arale-templatable/0.10.0/src/templatable-debug","garlly/handlebars/1.3.0/dist/cjs/handlebars-debug","garlly/arale-messenger/2.1.0/index-debug","garlly/handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug"], function(require, exports, module){
var $ = require("garlly/jquery/1.7.2/jquery-debug"),
    Dialog = require("garlly/arale-dialog/1.5.3/src/dialog-debug");

var template = require("garlly/arale-dialog/1.5.3/src/confirmbox-debug.handlebars");
...
define("garlly/arale-dialog/1.5.3/src/confirmbox-debug.handlebars", ["garlly/handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug"], function(require, exports, module){
var Handlebars = require("garlly/handlebars-runtime/1.3.0/dist/cjs/handlebars.runtime-debug")["default"];
module.exports = Handlebars.template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
